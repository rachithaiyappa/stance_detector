...
class DummyModel:
    def __init__(self):
        pass
    def generate(self, input_ids, return_dict_in_generate=True, output_scores=True, max_new_tokens=None):
        import torch
        class DummyScores:
            def __init__(self):
...
def dummy_runner(monkeypatch):
    ...
    monkeypatch.setattr("stance_detector.flant5_runner.T5ForConditionalGeneration", DummyModel)
    runner = FlanT5Runner(
        model_name="dummy",
        tokenizer_cache="",
        model_cache="",
